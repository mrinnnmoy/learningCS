...
class AppError extends Error {
    constructor(message, statusCode, code) {
        ...
        // true  → operational (expected runtime scenario) — safe to expose message
        // false → programmer bug — hide message in production
        this.isOperational = true;

        // Remove AppError constructor from the stack trace
